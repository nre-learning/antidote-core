...
import (
	...
	v1 "github.com/nre-learning/syringe/pkg/client/listers/kubernetes.com/v1"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options metav1.ListOptions) (runtime.Object, error) {
				...
				return client.KubernetesV1().Networks(namespace).List(options)
			},
			WatchFunc: func(options metav1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.KubernetesV1().Networks(namespace).Watch(options)
			},
		},
		&kubernetescomv1.Network{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *networkInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&kubernetescomv1.Network{}, f.defaultInformer)
}
