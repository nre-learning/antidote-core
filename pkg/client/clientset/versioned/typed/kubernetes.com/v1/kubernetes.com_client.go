...
// KubernetesV1Client is used to interact with features provided by the kubernetes.com group.
type KubernetesV1Client struct {
	restClient rest.Interface
}

func (c *KubernetesV1Client) Networks(namespace string) NetworkInterface {
